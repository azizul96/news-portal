    ...
    return (
        <div className="bg-white rounded-md">
            <div className='flex justify-between p-4'>
                ...
                <Link className='px-3 py-[6px] bg-purple-500 rounded-sm text-white hover:bg-purple-600' to='/dashboard/add-writer'>Add Writer</Link>
            </div>
                    ...
                    <tbody>
                        {
                            ...
                            <td className='px-6 py-4'>Alif</td>
                            ...
                            <td className='px-6 py-4'>alif@gmail.com</td>
